...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-YV2VSL5ETE"></script>
        <script
        ...
        <link rel="apple-touch-icon" href={IMAGE_PATHS.LOGO_SMALL} />
